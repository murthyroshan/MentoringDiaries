 ...
 * Organised by department code → semester → subject names.
 * Default: CSE (Computer Science & Engineering)
 *
 * Used by:
 *   - SubmitEntry Section B (frontend subject rating dropdowns)
 *   - DiaryController (subject rating field population)
 */
...
const SUBJECTS = {
    ...
    MECH: {
        1: ['Engineering Mathematics I', 'Engineering Physics', 'Engineering Chemistry', 'Engineering Mechanics', 'Engineering Graphics', 'English Communication'],
        2: ['Engineering Mathematics II', 'Thermodynamics', 'Material Science', 'Manufacturing Processes', 'Fluid Mechanics', 'Environmental Science'],
        3: ['Strength of Materials', 'Kinematics of Machinery', 'Heat Transfer', 'Metrology', 'Machine Drawing', 'Electrical Machines'],
        4: ['Dynamics of Machinery', 'Design of Machine Elements', 'Applied Thermodynamics', 'Refrigeration & AC', 'CNC Technology', 'Industrial Management'],
        5: ['Automobile Engineering', 'Finite Element Analysis', 'Robotics', 'Open Elective I', 'Elective I', 'CAD/CAM'],
        6: ['Power Plant Engineering', 'Mechatronics', 'Operations Research', 'Open Elective II', 'Elective II', 'Project Management'],
        7: ['Project Phase I', 'Advanced Manufacturing', 'Composite Materials', 'Professional Elective I', 'Seminar', 'Industrial Training Report'],
        8: ['Project Phase II', 'Professional Elective II', 'Entrepreneurship Development', 'Industry Internship'],
    },
    DEFAULT: {
...
/**
 * Get subjects for a given department and semester.
 * Falls back to DEFAULT if department not found.
 */
function getSubjectsForSemester(department = '', semester = 1) {
...
module.exports = { SUBJECTS, getSubjectsForSemester };
